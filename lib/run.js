...
for (var i = 1; i < keys.length; i++) {
	if (po.translations[''][keys[i]]) {
		...
		if (po.translations[''][keys[i]].comments && pot.translations[''][keys[i]].comments && po.translations[''][keys[i]].comments.reference !== pot.translations[''][keys[i]].comments.reference) {
			var comments = {
				changes: [],
